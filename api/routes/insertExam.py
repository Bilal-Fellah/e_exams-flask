...
def insert_exam():
    try:
        ...
        exam_unique_name = f"{user_id}_{int(time.time())}_exam_{exam_file.filename}"
        ...
        if "solution" in request.files:
            ...
            if solution_file.filename != "":
                ...
                solution_unique_name = f"{user_id}_{int(time.time())}_solution_{solution_file.filename}"
        ...
        file_data = {
            ...
            "exam_file_name": exam_unique_name,
            "solution_file_name": solution_unique_name,  # This will be None if no solution file was provided
        }
